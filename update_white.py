...
# Replace the entire footer wrapper div
content = re.sub(r'<div class="w-full fade-in-up stagger-3">.*?</footer>\n</div>', footer_html, content, flags=re.DOTALL)

# If it didn't catch it, try just footer
